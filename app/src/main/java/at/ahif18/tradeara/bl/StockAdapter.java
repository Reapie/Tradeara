...
public class StockAdapter extends RecyclerView.Adapter<StockHolder> {
    ...
    public StockAdapter(MainActivity mainActivity) {
        ...
        stocks = Arrays.asList(
                new Stock("Tesla", "TSL",25.26, 24.24),
                new Stock("Mercedes-Benz", "BNZ", 24.24, -25.24),
                new Stock("Ford", "Frd", 26.24, -20.24),
                new Stock("Apple Inc.", "APL", 30.24, -10.24),
                new Stock("Oneplus", "ONP", 150.88, 151.2)
        );
